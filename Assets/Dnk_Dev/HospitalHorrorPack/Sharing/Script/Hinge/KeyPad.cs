...
public class KeyPad : MonoBehaviour
{
    ...
    private void TryEvent()
    {
        ...
        if (doorOpen)
        {
            ...
            var newRot = Quaternion.RotateTowards(LockerDoor.transform.localRotation, Quaternion.Euler(0.0f, -90.0f, 0.0f), Time.deltaTime * 200);
            LockerDoor.transform.localRotation = newRot;
        }
        else
        {
            if (item != null && item2 != null)
